 ...
 */
final class Version20250301111507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, descr_c VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, matiere_c VARCHAR(255) NOT NULL, date_c DATETIME NOT NULL, support_c VARCHAR(255) NOT NULL, rating INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
